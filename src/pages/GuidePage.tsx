      ...
      <header className="border-b border-walnut/10 bg-paper">
        <div className="mx-auto max-w-[1180px] px-5 pb-12 pt-8 sm:px-8 sm:pb-16 sm:pt-10">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_300px] lg:items-end">
            <div>
              <div className="flex flex-wrap items-center gap-3"><span className="rounded-full bg-pine px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.16em] text-white">{guide.type}</span><span className="text-[10px] font-black uppercase tracking-[0.16em] text-amber">Practical guide</span></div>
